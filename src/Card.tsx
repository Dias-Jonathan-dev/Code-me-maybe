        ...
        if (display.type === 'name' && Object.keys(display.style).length > 0) {
            ...
            return (
                <div className="card-visual-content" style={display.style}>
                    ...
                    {cardId === 'transition-all-1s' && <div className="visual-box hover-effect" style={{ transition: 'all 1s ease', width: '80%', height: '80%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>Hover Moi</div>}
            ...
            return (
                <div className="card-visual-content" style={display.style}> {/* Style appliqué directement ici */}
